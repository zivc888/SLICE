...
for(cancerType in names(mut_spec_pvalues)){
  ...
  if(cancerType == "Lung Cancer"){
    jpeg(paste("/bigdata/zivcohen/graphs/dependency_profiles/",cancerType,".jpeg",sep=""),
...
for(cancerType in names(mut_spec_pvalues)){
  ...
  if(cancerType == "Lung Cancer"){
    jpeg(paste("/bigdata/zivcohen/graphs/dependency_profiles/",cancerType,".jpeg",sep=""),
       height = 1000, width = 2500, units = "px", res = 100)
    draw(ht)
    dev.off()
    next
  }
...
drivers <- read_lines("/bigdata/zivcohen/graphs/dependency_profiles/rows.txt")
partners <- read_lines("/bigdata/zivcohen/graphs/dependency_profiles/cols.txt")
...
jpeg(paste("/bigdata/zivcohen/graphs/dependency_profiles/all_results_circles.jpeg",sep=""),
...
jpeg(paste("/bigdata/zivcohen/graphs/dependency_profiles/all_results_top_pairs.jpeg",sep=""),
...
path <- "/bigdata/zivcohen/SLICE_aux_analysis/RB1_survival_tcga.txt"
